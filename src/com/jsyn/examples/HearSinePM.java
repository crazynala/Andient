...
public class HearSinePM extends JApplet
{
	...
	private void setupGUI()
	{
		...
		knobPanel.add( setupPortKnob( modulator.frequency, 1000.0, "MFreq" ) );
		knobPanel.add( setupPortKnob( modulator.amplitude, 10.0, "MAmp" ) );
		knobPanel.add( setupPortKnob( carrier.frequency, 1000.0, "CFreq" ) );
		knobPanel.add( setupPortKnob( carrier.amplitude, 1.0, "CAmp" ) );
