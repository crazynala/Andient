...
*/
public class LangDelayRight extends SynthNote
{
    ...
    public LangDelayRight( SynthContext synthContext )
    {
        super( synthContext );
        // Create unit generators.
        add( delay = new DelayUnit(synthContext, 0.5 ) );
        add( delay2 = new DelayUnit(synthContext, 0.7 ) );
