...
*/
public class LangDroneBass extends SynthNote
{
    ...
    public LangDroneBass()
    {
        this( Synth.getSharedContext() );
    }
    public LangDroneBass( SynthContext synthContext )
    {
        super( synthContext );
        ...
        addPort( amplitude = triOsc.amplitude, "amplitudeSetting" );
        ...
        addPort( realFreq = triOsc.frequency, "realFreq" );
        realFreq.setup( 10.0, 200.0, 12000.0 );
        triOsc.phase.set( 0, 0.9429425597190857 );
        triOsc.output.connect( bandPass.input);
        triOsc.output.connect( bandPass2.input);
        
        addPort( cutoff = expLag.input, "cutoff" );
        cutoff.setup( 0.0, 100.0, 12000.0 );
        mult.inputB.set( 0, 2.0 );
        mult.output.connect( bandPass2.frequency);

        addPort( reson = expLag2.input, "reson" );
        reson.setup( 0.0, 30.0, 50.0 );
        expLag.halfLife.set( 0, 1.57163871335797E-4 );
        expLag.current.set( 0, 100.0030288696289 );
        expLag.output.connect( bandPass.frequency);
        expLag.output.connect( mult.inputA);
        expLag2.halfLife.set( 0, 1.57163871335797E-4 );
        expLag2.current.set( 0, 29.999242782592773 );
